...
import loader
import presets
from model import gen_loss_function, train_epoch, kl_divergence, crossentropy_cost
...
if __name__ == "__main__":
    ...
    (line_acc_student_live,) = ax_accuracy.plot(
        [], label="Live Student (sgd, lr=0.2; momentum=0.8)"
    )
    ...
    for era in range(teacher_eras):
        ...
        for epoch in range(student_epochs):
            ...
            model_student_live.params, optimizer_student_state_live, losses = (
                train_epoch(
